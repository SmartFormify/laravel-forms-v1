# Laravel Blade Real Estate Enquiry Form

A basic **Real Estate Enquiry** form built with Laravel Blade that submits form data directly to a **SmartFormify endpoint**.
...
Route::view('/real-estate-enquiry', 'real_estate_enquiry');
```
...
```text
resources/views/real_estate_enquiry.blade.php
```

Add the Real Estate Enquiry form code.
...
```text
public/css/real_estate_enquiry.css
```
...
```text
http://127.0.0.1:8000/real-estate-enquiry
```
